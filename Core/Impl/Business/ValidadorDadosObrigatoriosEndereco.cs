        ...
        public string Processar(EntidadeDominio entidade)
        {
            if (entidade.GetType().Name.Equals("Endereco"))
            {
                ...
                if(endereco.TipoEndereco < 1 || endereco.TipoLogradouro < 1 || endereco.TipoResidencia < 1 ||
                    ...
                    string.IsNullOrEmpty(endereco.Logradouro) || string.IsNullOrWhiteSpace(endereco.Logradouro) ||
                    string.IsNullOrEmpty(endereco.Cep) || string.IsNullOrWhiteSpace(endereco.Cep) ||
                    string.IsNullOrEmpty(endereco.Bairro) || string.IsNullOrWhiteSpace(endereco.Bairro))
                {
