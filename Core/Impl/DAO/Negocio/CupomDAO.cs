    ...
    public class CupomDAO : AbstractDAO
    {
        ...
        public override List<EntidadeDominio> Consultar(EntidadeDominio entidade)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(cupom.Codigo) && !string.IsNullOrWhiteSpace(cupom.Codigo) &&
                ...
                else if (!string.IsNullOrEmpty(cupom.Codigo) && !string.IsNullOrWhiteSpace(cupom.Codigo) && cupom.Usado != null)
                    cmdTextoCupom = "SELECT * FROM Cupons WHERE Codigo = @Codigo AND Usado = @Usado";
                    ...
                    cupom.DataExpiracao == DateTime.MinValue || cupom.DataExpiracao == null &&
                    cupom.Usado != null && cupom.Tipo != '\0')
                    cmdTextoCupom = "SELECT * FROM Cupons WHERE UsuarioId = @UsuarioId AND Usado = @Usado AND Tipo = @Tipo";
                else if(cupom.UsuarioId != null && cupom.UsuarioId != 0)
